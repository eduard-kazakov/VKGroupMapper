	...
	<script type="text/javascript">
        ...
        function onEachFeatureStartWalking(feature, layer) {
            if (feature.properties.SUM_count >= 0) {
                allValues.push(feature.properties.SUM_count);
            }
		}
        ...
        <?php
            ...
            echo	"'<b>' + props.NAME + '</b><br />' + (negativeToZero(props.SUM_count)).toFixed(0) + ' участников.'";
		...
		function style(feature) {
			return {
				...
				dashArray: '3',
				fillOpacity: 0.7,
				fillColor: getColor((feature.properties.SUM_count))
			};
		}
